...
export default function Hero() {
  return (
    <div class="bg-hero-bg bg-cover bg-center">
            ...
            <div className="flex flex-col justify-center space-y-4">
              <div className="space-y-4">
                <p className="-mt-12 mb-16 text-gray-400">
                  索飞 AI 是基于 6 百亿 MoE 模型底座的工程安全认知大模型，致力于实现类人智慧的通用工程智能
                </p>
              ...
              <div className="flex flex-col md:flex-row items-center justify-center space-y-8 md:space-y-0 md:space-x-8">
                <Link href="https://www.safebition.com/chat" className="md:p-8 p-6 bg-[#FDFEFE] rounded-xl transition-transform transform hover:scale-105 shadow-sm w-1/2 opacity-80">
                  <div>
                    <h2 className="text-2xl font-semibold text-blue-500 mb-4">立即体验</h2>
                    <p className="text-gray-500 mb-2">免费使用，信息一触即达</p>
                  </div>
                </Link>
                <div className="md:p-8 p-6 bg-[#FDFEFE] rounded-xl transition-transform transform hover:scale-105 shadow-sm w-1/2 opacity-80">
                  <h2 className="text-2xl font-semibold text-blue-500 mb-4">接入API</h2>
                  <p className="text-gray-500 mb-2">注册获百万 tokens，敬请期待</p>
                </div>
              </div>
            </div>
          </div>
